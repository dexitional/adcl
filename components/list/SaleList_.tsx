    ...
    <Table
        ...
        <div className="gap-y-1 gap-x-2 grid grid-cols-7 text-center">
            ...
            <span className="col-span-1">
              <span className="p-1 px-2 border border-slate-400 bg-slate-100 text-slate-600 text-[0.7rem] uppercase font-semibold rounded">{saleType == 'daily' && moment().format('MMM DD, YYYY')}</span>
            </span>
        </div>
        }>
